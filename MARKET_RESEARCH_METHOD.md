...
16. 在文章間切換與由雷達／圖譜開啟文章時，確認閱讀區立即回到頂端；雷達已升格候選開文後，
    ...
    支撐的結論。另抽查至少一個達 120 字、含兩個以上句末標點的主正文段落：320／390／780／
    781／884／1181／1280px 都須依實際 section 內容寬度顯示原句停頓，且全頁無水平 overflow；
    ...
    左側。另抽查至少一個 120 字以上、含兩個中文句末的主正文
    段落：窄幅須逐句形成視覺停頓，寬幅仍連續；兩邊的 `textContent` 都須和 payload 只差可確定的
