...
DOM 閱讀順序固定為「閱讀任務 → 完整新手三句重點 → 產業角色 → 學習路線定位 → metadata →
...
不代表上下游、受惠、訂單或因果關係，也不得建立 knowledge graph edge。
