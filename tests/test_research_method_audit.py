...
class ResearchMethodAuditTest(unittest.TestCase):
    ...
    def test_audit_exposes_counts_without_fake_accuracy_score(self):
        ...
        self.assertEqual(self.current["scope"]["financialAssessments"], 5)
        self.assertEqual(self.current["graphs"]["financialAssessments"], 5)
        self.assertEqual(self.current["graphs"]["financialContractComplete"], 5)
