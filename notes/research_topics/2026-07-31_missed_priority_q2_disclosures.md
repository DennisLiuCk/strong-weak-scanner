...
confidence_basis: 六家公司 Q2 一手揭露與六份 MOPS 正式附件索引已能重估證據強弱；力成、旺宏、欣銓與環球晶核閱季報進一步把本業、存貨會計、金融工具、現金流、資產轉列、量產時鐘及產品收入歸因拆開，但研究核對仍不等於正式筆記 evidence pack 與獨立 reviewer，復工、ASP、長供與 HBM2 訂單等市場主張仍未驗證
...
- 環球晶完整季報顯示營收季增 8.79%、營業利益季減 3.56%，業外淨額季增 22.91 億元才把淨利推高 99.33%；Siltronic 評價不能改名為晶圓漲價。
- 力成季報仍不能證明 HBM2 收入；旺宏毛利率要拆存貨回升利益；欣銓 7 月量產也不能倒填 6 月底截止的 Q2 收入，事件、會計與產品歸因都要逐層過關。
...
- [MOPS 115Q2 文件索引](https://doc.twse.com.tw/server-java/t57sb01?step=1&colorchg=1&co_id=2308&year=115&seamon=2&mtype=A)
  列出 `202602_2308_AI1.pdf`（7 月 29 日 16:26:39，1,808,979 bytes）；這是可開始封存的
  附件 locator，不是本輪已完成的內容簽核。
