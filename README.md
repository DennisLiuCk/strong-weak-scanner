...
2. **最近研究**：首頁只保留正式筆記、多空小作文、市場議題三類入口；事件錨點歸入市場議題，
   ...
   的查核狀態與觀察層警語。點開文章後，桌機預設進入專注閱讀；第一屏先回答結論、已知、
   未知、影響範圍與下一步，正文結束後用「從這篇接著學」連到同公司文章、既有知識圖譜或
   ...
   證據邊界與下一個驗證節點。「族群矩陣」預設以「族群／已完成／最大缺口／下一步」四欄
   呈現，完整九欄盤點與方法說明收在查核附錄；其中題材財務影響仍區分公司整體、事業部、
