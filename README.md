...
2. **最近研究**：首頁只保留正式筆記、多空小作文、市場議題三類入口；事件錨點歸入市場議題，
   ...
   可展開的研究查核附錄。研究中心的
   「研究雷達」以「下一步研究什麼」呈現，卡片正面只放現在值得看的原因與下一份證據，
   反證條件、來源與方法稽核收在查核區；這是研究資源排序，不是投資評分。知識圖譜則用同一
   ...
   證據邊界與下一個驗證節點。「族群矩陣」先用「公司本業底稿 → 題材具名連結 → 財務落地」
   解釋三層研究進度，再以「族群／已完成／最大缺口／下一步」四欄呈現；矩陣數字不是多空
   評分，完整九欄盤點與方法說明收在查核附錄。其中題材財務影響仍區分公司整體、事業部、
